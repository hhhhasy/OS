...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	67250513          	addi	a0,a0,1650 # 8006a8 <main+0x142>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	a1250513          	addi	a0,a0,-1518 # 800a68 <error_string+0x138>
...
exit(int error_code) {
  ...
  80013a:	59250513          	addi	a0,a0,1426 # 8006c8 <main+0x162>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80019a:	54a78793          	addi	a5,a5,1354 # 8006e0 <main+0x17a>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001f6:	522a8a93          	addi	s5,s5,1314 # 800714 <main+0x1ae>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001fe:	736b8b93          	addi	s7,s7,1846 # 800930 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800454:	2c060613          	addi	a2,a2,704 # 800710 <main+0x1aa>
  ...
  800466:	29e60613          	addi	a2,a2,670 # 800700 <main+0x19a>
  ...
  800478:	28440413          	addi	s0,s0,644 # 8006f8 <main+0x192>
  ...
  800502:	1fa40413          	addi	s0,s0,506 # 8006f8 <main+0x192>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  800518:	1e5a0a13          	addi	s4,s4,485 # 8006f9 <main+0x193>
...
main(void) {
  ...
  80056c:	49050513          	addi	a0,a0,1168 # 8009f8 <error_string+0xc8>
main(void) {
  ...
  80057c:	c571                	beqz	a0,800648 <main+0xe2>
  ...
  800586:	4c650513          	addi	a0,a0,1222 # 800a48 <error_string+0x118>
  ...
  800596:	50e50513          	addi	a0,a0,1294 # 800aa0 <error_string+0x170>
  ...
  8005cc:	55050513          	addi	a0,a0,1360 # 800b18 <error_string+0x1e8>
  8005d0:	ad3ff0ef          	jal	ra,8000a2 <cprintf>

    cprintf("exit pass.\n");
  8005d4:	00000517          	auipc	a0,0x0
  8005d8:	55450513          	addi	a0,a0,1364 # 800b28 <error_string+0x1f8>
  ...
  8005ee:	4d668693          	addi	a3,a3,1238 # 800ac0 <error_string+0x190>
  8005f2:	00000617          	auipc	a2,0x0
  8005f6:	48660613          	addi	a2,a2,1158 # 800a78 <error_string+0x148>
  8005fa:	02000593          	li	a1,32
  8005fe:	00000517          	auipc	a0,0x0
  800602:	49250513          	addi	a0,a0,1170 # 800a90 <error_string+0x160>
  800606:	a21ff0ef          	jal	ra,800026 <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  80060a:	00000697          	auipc	a3,0x0
  80060e:	4e668693          	addi	a3,a3,1254 # 800af0 <error_string+0x1c0>
  800612:	00000617          	auipc	a2,0x0
  800616:	46660613          	addi	a2,a2,1126 # 800a78 <error_string+0x148>
  80061a:	02100593          	li	a1,33
  80061e:	00000517          	auipc	a0,0x0
  800622:	47250513          	addi	a0,a0,1138 # 800a90 <error_string+0x160>
  800626:	a01ff0ef          	jal	ra,800026 <__panic>
    assert(pid > 0);
  80062a:	00000697          	auipc	a3,0x0
  80062e:	44668693          	addi	a3,a3,1094 # 800a70 <error_string+0x140>
  800632:	00000617          	auipc	a2,0x0
  800636:	44660613          	addi	a2,a2,1094 # 800a78 <error_string+0x148>
  80063a:	45f5                	li	a1,29
  80063c:	00000517          	auipc	a0,0x0
  800640:	45450513          	addi	a0,a0,1108 # 800a90 <error_string+0x160>
  800644:	9e3ff0ef          	jal	ra,800026 <__panic>
        cprintf("I am the child.\n");
  800648:	00000517          	auipc	a0,0x0
  80064c:	3d850513          	addi	a0,a0,984 # 800a20 <error_string+0xf0>
  800650:	a53ff0ef          	jal	ra,8000a2 <cprintf>
        cprintf("*p = 0x%x\n", *p);     // 读取该地址的值
  800654:	00800437          	lui	s0,0x800
  800658:	58843583          	ld	a1,1416(s0) # 800588 <main+0x22>
  80065c:	00000517          	auipc	a0,0x0
  800660:	3dc50513          	addi	a0,a0,988 # 800a38 <error_string+0x108>
  800664:	a3fff0ef          	jal	ra,8000a2 <cprintf>
        *p = 0x222;                     // 尝试写入新值
  800668:	22200793          	li	a5,546
        cprintf("*p = 0x%x\n", *p);     // 验证写入是否成功
  80066c:	22200593          	li	a1,546
        *p = 0x222;                     // 尝试写入新值
  800670:	58f43423          	sd	a5,1416(s0)
        cprintf("*p = 0x%x\n", *p);     // 验证写入是否成功
  800674:	00000517          	auipc	a0,0x0
  800678:	3c450513          	addi	a0,a0,964 # 800a38 <error_string+0x108>
  80067c:	a27ff0ef          	jal	ra,8000a2 <cprintf>
        yield();
  800680:	acfff0ef          	jal	ra,80014e <yield>
        yield();
  800684:	acbff0ef          	jal	ra,80014e <yield>
        yield();
  800688:	ac7ff0ef          	jal	ra,80014e <yield>
        yield();
  80068c:	ac3ff0ef          	jal	ra,80014e <yield>
        yield();
  800690:	abfff0ef          	jal	ra,80014e <yield>
        yield();
  800694:	abbff0ef          	jal	ra,80014e <yield>
        yield();
  800698:	ab7ff0ef          	jal	ra,80014e <yield>
        exit(magic);
  80069c:	00001517          	auipc	a0,0x1
  8006a0:	96452503          	lw	a0,-1692(a0) # 801000 <magic>
  8006a4:	a8bff0ef          	jal	ra,80012e <exit>
